...
### Changed
- Updated bgu courses list for 2026 summer semester
...
### Changed
- Updated bgu courses list for 2026 spring semester
...
### Added
- Course addition search support for names (hebrew and english).
- Dropdown menu for course addition search results.
- Placeholder text for username, password and ID inputs in options page.
...
- Options page course name input border not updating correctly.
